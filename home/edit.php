...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $alamat = $siswa['alamat'];
        $agama = $siswa['agama']; // Ambil agama
        $nama_ayah = $siswa['nama_ayah']; // Ambil nama ayah
        $nama_ibu = $siswa['nama_ibu']; // Ambil nama ibu
    } else {
    ...
    if (!ctype_digit($nis)) {
        ...
        if ($_FILES['foto']['name']) {
            ...
            if ($uploadOk && move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                ...
                $sql = "UPDATE siswa SET nama = '$nama', nis = '$nis', kelas = '$kelas', ttl = '$ttl', jenis_kelamin = '$jenis_kelamin', alamat = '$alamat', agama = '$agama', nama_ayah = '$nama_ayah', nama_ibu = '$nama_ibu', foto = '$foto', created_at = '$created_at' WHERE id = '$id_siswa'";
            ...
            // Jika foto tidak diupload, hanya update data lainnya
            $sql = "UPDATE siswa SET nama = '$nama', nis = '$nis', kelas = '$kelas', ttl = '$ttl', jenis_kelamin = '$jenis_kelamin', alamat = '$alamat', agama = '$agama', nama_ayah = '$nama_ayah', nama_ibu = '$nama_ibu', created_at = '$created_at' WHERE id = '$id_siswa'";
            if (mysqli_query($koneksi, $sql)) {
                header("Location: absen.php");
                exit();
            } else {
...
<div class="container mt-5 col-md-8">
    <div class="glass">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label>Foto Siswa (Kosongkan jika tidak diganti)</label>
            ...
            <div class="text-center">
                ...
                <a href="absen.php" class="btn btn-dark btn-modern ms-2">
                    Kembali
                </a>
            </div>
